        ...
        <div className="container liscontainer">
          <div className="facilitycontent">
            ...
            <div className="facilitCard">
              ...
              <div className="facontent">
                <div className="factitle">Personal Attention to Every Child</div>
                <p>
                  Our School is committed to providing a safe, supportive environment to help grow each and every child.
                </p>
              </div>
            </div>
            ...
            <div className="facilitCard">
              <div className="facilimages">
                <img src="./culturalactivities.jpg" alt="" />
              </div>
              <div className="facontent">
            ...
            <div className="facilitCard">
              ...
              <div className="facontent">
                <div className="factitle">State of the Science, Chemistry, Biology and Physics</div>
                <p>
                  {" "}
